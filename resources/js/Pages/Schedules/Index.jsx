...
import AuthenticatedLayout from '@/Layouts/AuthenticatedLayout'; // Ensure this import is present

// Aktifkan plugin dayjs
dayjs.extend(localizedFormat);
dayjs.extend(isToday);
dayjs.extend(isTomorrow);
dayjs.extend(isBetween); // Extend with isBetween
dayjs.locale('id');

// Modal Component for Shift Details
...
// New component for displaying a list of schedules in detail
...
const Index = () => {
  ...
  // State for date filters, initialized from props or default to empty
  ...
  const groupedSchedulesByDateShiftSubSection = schedules.reduce((acc, schedule) => {
    ...
    // This warning helps identify data integrity issues in the backend/database.
